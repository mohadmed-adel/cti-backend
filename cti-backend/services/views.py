...
from .serializers import (
    ...
    CommentSerializer,RequestedServicesImageSerializer
)
...
class RequestedServicesImageView(APIView):
    permission_classes=[IsAuthenticated]
    parser_classes = (MultiPartParser, FormParser)

    def post(self, request, id, *args, **kwargs):
        try:
            requested_service = RequestedServices.objects.get(pk=id)
        except RequestedServices.DoesNotExist:
        ...
        requested_service.attachment = attachment_file
        requested_service.save()

        serializer = RequestedServicesImageSerializer(requested_service,context={"request": request})
